...
#include <string>
using namespace std;
// CSC237 Project 2:  this class specificaton is 
// provided as "starter code" for Project 2.
// The student's program must NOT modify the
// InventoryItem class specification.
class InventoryItem {
private:
